...
public class LoginDialog extends Activity {
    ...
    TextView link;
    TextView link2;
    public String loginActivity = "main";
    ...
    {  int start = text.indexOf("이용약관");
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View widget) {
                Intent goToAgreeRule = new Intent(LoginDialog.this, AgreeWebViewActivity.class);
    ...
    public void setPrivateLink(String text)
    {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            @Override
            public void onClick(View widget) {
                Intent goToAgreeRule = new Intent(LoginDialog.this, PrivateInformationUsingAgreeWebView.class);
                startActivity(goToAgreeRule);
                overridePendingTransition(R.anim.slide_up_info,R.anim.no_change);
            }
        };
    ...
    public class SessionCallback implements ISessionCallback {
        ...
        public void onSessionOpened() {
            Log.e("세션","성공");
            if (loginActivity.equalsIgnoreCase("soldView")) {
                finish();
            }
            else {
